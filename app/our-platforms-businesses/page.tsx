...
export default function Platforms() {
  return (
    <>
    <div className="bg-[#0D1323] px-2 -mt-30 bg-[url(/images/banner-platforms-01.png)] bg-center bg-cover bg-no-repeat relative text-white">
      {/* Overlay azul oscuro */}
      {/*<div className="absolute inset-0 bg-[#0D1323]/70"></div>*/}
      
      <div className="max-w-6xl py-60 mx-auto grid grid-cols-3 gap-x-20 py-4 gap-y-5 relative z-10">
    ...
    <div className="px-2 py-10">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-x-20 py-4">
        <div className="m-auto gap-4 grid">
          <h2 className="text-2xl font-bold">How We Build and Operate Platforms</h2>
          <p>
    ...
    <div className="px-2 py-10 bg-[#1F1F1F]">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-x-10 py-4">
        <div className="bg-[#282828] text-white p-8 gap-4 grid">
          <h2 className="text-2xl text-2xl text-[#E4D3B9] font-bold">Logistics & Freight Platforms</h2>
          <p>
        ...
        <div className="bg-[#282828] text-white p-8 gap-4 grid">
          <h2 className="text-2xl text-2xl text-[#E4D3B9] font-bold">Industrial Real Estate Platforms</h2>
          <p>
        ...
        <div className="bg-[#282828] text-white p-8 gap-4 grid">
          <h2 className="text-2xl text-2xl text-[#E4D3B9] font-bold">Infrastructure & Operational Platforms</h2>
          <p>
    ...
    <div className="px-2 py-20">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-x-20 py-4">
        <div className="border p-10 rounded-md gap-4 grid">
          <h2 className="text-2xl font-bold">A Consistent Framework Across All Platforms</h2>
          <p>
        ...
        <div className="border p-10 rounded-md gap-4 grid">
          <h2 className="text-2xl font-bold">Built for Long-Term Performance</h2>
          <p>
